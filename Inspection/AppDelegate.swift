...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, handleOpenURL url: NSURL) -> Bool {
        ...
        DB?.reload()
        ((self.window?.rootViewController as? RootViewController)?.selectedViewController as? UINavigationController)?.popToRootViewControllerAnimated(false)
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Inspection", withExtension: "momd")!
